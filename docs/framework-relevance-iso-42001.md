...
These notes explain how NETRUNNER uses ISO/IEC 42001 references. They are traceability aids, not certification claims.
...
## How NETRUNNER Uses Section 9

NETRUNNER turns local adversarial testing into performance-evaluation evidence:
...
NETRUNNER does not determine ISO/IEC 42001 conformance. It helps show where an AI management system would need evidence that controls are working, failing, or improving over time.
