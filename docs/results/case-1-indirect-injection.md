...
- `configuration_digest`: `f58084864723a055e37fcb3b95c612a48242720eb609c049a7e8ed54df619c4e`
...
| Reference | `retrieve_email` → `retrieve_document` → `send_email` | yes / yes / yes | allowed / **denied** / **denied** | yes / no / no | `CONTROL_HELD` |
